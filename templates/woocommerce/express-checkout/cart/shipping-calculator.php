...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form form-row" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<div class="col-12" id="calc_shipping_country_field">
				<div class="form-label-group">
					<select name="calc_shipping_country" id="calc_shipping_country" class="custom-select country_to_state country_select" rel="calc_shipping_state">
					...
					<label for="calc_shipping_state"><?php esc_html_e( 'Select a country&hellip;', 'woocommerce' ); ?></label>
				</div>
			</div>
		<?php endif; ?>

		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
			<div class="col-12" id="calc_shipping_state_field">
				<div class="form-label-group">
					<?php
					...
					if ( is_array( $states ) && empty( $states ) ) {
						...
						?>
							<select name="calc_shipping_state" class="custom-select state_select" id="calc_shipping_state" data-placeholder="<?php esc_attr_e( 'State / County', 'woocommerce' ); ?>">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			<div class="col-12" id="calc_shipping_city_field">
				<div class="form-label-group">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			<div class="col-12" id="calc_shipping_postcode_field">
				<div class="form-label-group">
					...
					<label for="calc_shipping_postcode"><?php esc_attr_e( 'City', 'woocommerce' ); ?></label>
				</div>
			</div>
		<?php endif; ?>
