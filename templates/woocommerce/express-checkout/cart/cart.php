...
<div class="row">
	...
	<div class="col-lg-7 order-lg-1">
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
						...
						<ul class="list-unstyled">
							...
							foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
								...
								if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
									...
									?>
									<li class="cart-item cart_item pb-4 mb-4">
										<div class="row">
											<div class="col-sm-8 mb-3 mb-sm-0">
												<div class="media">
													...
													if ( ! $product_permalink ) {
														...
														printf( '<a class="mr-3" href="%s">%s</a>', esc_url( $product_permalink ), $thumbnail ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
													}
													?>
											...
											<div class="col-sm-4 text-sm-right">
												...
												<div class="product-remove">
													...
													echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
														...
														sprintf(
															'<a href="%s" class="btn btn-link remove text-secondary" aria-label="%s" data-product_id="%s" data-product_sku="%s">%s</a>',
			...
			<input type="submit" class="d-none" name="apply_coupon" id="trigger_coupon"/>
